...
namespace QuanLyBanHangVer1
{
    public partial class frmPhieuNhap : Form
    {
        ...
        public void LoadDataGridView()
        {
            ...
            ncc= new DataTable();
            ncc = Functions.LoadMaNCC();
            cbMaNhaCungCap.DataSource= ncc;
            cbMaNhaCungCap.ValueMember = "MaNhaCungCap";
            dgvDanhSach.Columns[0].HeaderText = "Mã Phiếu Nhập";
            ...
            dgvDanhSach.Columns[4].HeaderText = "Mã Nhà Cung Cấp";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * FROM PHIEUNHAP WHERE MaPhieuNhap = N'" + username + "'";
            ...
            if (MessageBox.Show("Chắc Chắn Muốn Thêm ?", "Thông Báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                {
                    dt = Functions.ThemPhieuNhap(txtMaPhieuNhap.Text, dpNgayNhap.Text, float.Parse(txtThanhTien.Text), cbMaNhanVien.Text, cbMaNhaCungCap.Text, float.Parse(txtDonGia.Text), int.Parse(txtSoLuong.Text), cbMaHangHoa.Text);
                    dgvDanhSach.DataSource = dt;
        ...
        private void btnHuy_Click(object sender, EventArgs e)
        {
            ...
            tong = Functions.TinhTongTien(cbMaNhaCungCap.Text);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Functions.XoaPhieuNhap(txtMaPhieuNhap.Text);
                dgvDanhSach.DataSource = dt;
        ...
        {
            if (dgvDanhSach.Rows[0].Cells == null) {
