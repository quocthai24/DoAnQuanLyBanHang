...
{
    public partial class frmTraCuuHoaDonMua : Form
    {
        DataTable dt,maNCC;
        public frmTraCuuHoaDonMua()
        {
            InitializeComponent();
        }

        private void frmTraCuuHoaDonMua_Load(object sender, EventArgs e)
        {
            LoadDataGridView();
        }
        public void LoadDataGridView()
        {
            ...
            maNCC = new DataTable();
            maNCC = Functions.LoadMaNCC();
            cbMaNCC.DataSource = maNCC;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            tong = Functions.TinhTongTien(cbMaNCC.Text);
        ...
        {
            dt = Functions.TimKiemPhieuNhap(cbMaNCC.Text);
            dgvDanhSach.DataSource = dt;
        }
    }
}
